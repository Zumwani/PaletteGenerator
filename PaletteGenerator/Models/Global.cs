...
using static PaletteGenerator.Models.Settings;
...
namespace PaletteGenerator.Models
{
    ...
    static class Global
    {
        ...
        public static Property<float> Hue           { get; } = new Property<float>(0);
        ...
        public static string Version => typeof(Window).Assembly.GetName().Version.ToString();
